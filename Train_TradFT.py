...
from load_model import get_gpt2_with_traditional_fine_tuning, evaluate_model
...
#######################################################################################################
# Load the GPT-2 with last layer fine tuning model
lora_dict = get_gpt2_with_traditional_fine_tuning()
...
#######################################################################################################
#------------------------------------ TRAINING ENDS HERE ---------------------------------------------#
gpt_model.save("gpt2_with_traditional_fine_tuning.pt") 